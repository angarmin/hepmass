...
def model(X_train,y_train,X_test,rs=0):
    ...
    #parámetros fijos: 
    params = {'solver': ['lbfgs'], 'max_iter': [1000], 'alpha': [0.0001], 'hidden_layer_sizes':[25], 'random_state':[rs],
             'learning_rate':['constant'],'activation':[ 'tanh']}    #model = SVC(probability=True) 
...
with open("/home/angela/Notebook/machine_learning/normalizados/btag_sis_error/rf_traincte_semcte.txt", "wb") as fp:   #Pickling
    pickle.dump(l, fp)
    
with open("/home/angela/Notebook/machine_learning/normalizados/btag_sis_error/rf_traincte_semcte.txt", "rb") as fp:   # Unpickling
    b = pickle.load(fp)
...
with open("/home/angela/Notebook/machine_learning/normalizados/btag_sis_error/rf_traincte_semvar.txt", "wb") as fp:   #Pickling
    pickle.dump(l, fp)
    
with open("/home/angela/Notebook/machine_learning/normalizados/btag_sis_error/rf_traincte_semvar.txt", "rb") as fp:   # Unpickling
    b = pickle.load(fp)
...
with open("/home/angela/Notebook/machine_learning/normalizados/btag_sis_error/rf_trainvar_semvar.txt", "wb") as fp:   #Pickling
    pickle.dump(l, fp)
    
with open("/home/angela/Notebook/machine_learning/normalizados/btag_sis_error/rf_trainvar_semvar.txt", "rb") as fp:   # Unpickling
    b = pickle.load(fp)
